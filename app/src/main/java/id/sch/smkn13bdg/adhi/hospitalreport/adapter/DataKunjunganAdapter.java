...
import id.sch.smkn13bdg.adhi.hospitalreport.kunjungan.KunjunganPoliFragment;

/**
 * Created by adhi on 05/12/17.
 */

public class DataKunjunganAdapter extends RecyclerView.Adapter<DataKunjunganAdapter.MyViewHolder> {
    ...
    public DataKunjunganAdapter(List<DataGrafikController> Listdata) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_datagrafik, parent, false);
